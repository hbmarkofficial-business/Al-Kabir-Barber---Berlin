  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Al-Kabir Barber</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Al-Kabir Barber in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Al-Kabir Barber | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Al-Kabir Barber | Premium Barbershop Berlin" />
        <meta
